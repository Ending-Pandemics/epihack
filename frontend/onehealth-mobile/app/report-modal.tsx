    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 40 }}>
        <Animated.View style={{ transform: [{ scale: scaleAnim }], alignItems: 'center' }}>
          ...
          <Text style={{ fontSize: 22, fontWeight: '700', color: '#111', marginBottom: 6 }}>Report Submitted!</Text>
        ...
        <View style={{ position: 'absolute', bottom: 50, left: 24, right: 24, gap: 10 }}>
          ...
          <TouchableOpacity activeOpacity={0.7}
            ...
            <Text style={{ color: GREEN, fontSize: 14, fontWeight: '500' }}>Submit Another</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
